...
class Route {
  ...
  @override
  String toString() => 'Route[routeId=$routeId, name=$name, description=$description, stops=$stops, schedule=$schedule, isActive=$isActive, stopCount=$stopCount, totalStudents=$totalStudents, createdAt=$createdAt, updatedAt=$updatedAt]';
