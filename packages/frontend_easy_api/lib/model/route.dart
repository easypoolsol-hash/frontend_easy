...
class Route {
  ...
  @override
  String toString() => 'Route[routeId=$routeId, name=$name, description=$description, colorCode=$colorCode, linePattern=$linePattern, isActive=$isActive, stopCount=$stopCount, totalStudents=$totalStudents, routeStops=$routeStops, createdAt=$createdAt, updatedAt=$updatedAt]';
