  ...
  static PatchedBus? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return PatchedBus(
        ...
        assignedStudentsCount: mapValueOfType<String>(json, r'assigned_students_count'),
        utilizationPercentage: mapValueOfType<String>(json, r'utilization_percentage'),
        isAvailable: mapValueOfType<String>(json, r'is_available'),
