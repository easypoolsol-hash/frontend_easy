...
class PatchedRoute {
  ...
  @override
  String toString() => 'PatchedRoute[routeId=$routeId, name=$name, description=$description, colorCode=$colorCode, linePattern=$linePattern, isActive=$isActive, stopCount=$stopCount, totalStudents=$totalStudents, routeStops=$routeStops, createdAt=$createdAt, updatedAt=$updatedAt]';
