...
class PatchedStudent {
  ...
  @override
  String toString() => 'PatchedStudent[studentId=$studentId, school=$school, schoolStudentId=$schoolStudentId, decryptedName=$decryptedName, grade=$grade, section=$section, addressLatitude=$addressLatitude, addressLongitude=$addressLongitude, assignedBus=$assignedBus, status=$status, enrollmentDate=$enrollmentDate, schoolDetails=$schoolDetails, busDetails=$busDetails, parents=$parents, photos=$photos, createdAt=$createdAt, updatedAt=$updatedAt]';
