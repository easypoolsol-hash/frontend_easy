...
part of 'bus_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

const BusRequestStatusEnum _$busRequestStatusEnum_active =
    const BusRequestStatusEnum._('active');
const BusRequestStatusEnum _$busRequestStatusEnum_maintenance =
    const BusRequestStatusEnum._('maintenance');
const BusRequestStatusEnum _$busRequestStatusEnum_retired =
    const BusRequestStatusEnum._('retired');

BusRequestStatusEnum _$busRequestStatusEnumValueOf(String name) {
  switch (name) {
    case 'active':
      return _$busRequestStatusEnum_active;
    case 'maintenance':
      return _$busRequestStatusEnum_maintenance;
    case 'retired':
      return _$busRequestStatusEnum_retired;
    default:
      throw ArgumentError(name);
  }
}

final BuiltSet<BusRequestStatusEnum> _$busRequestStatusEnumValues =
    BuiltSet<BusRequestStatusEnum>(const <BusRequestStatusEnum>[
  _$busRequestStatusEnum_active,
  _$busRequestStatusEnum_maintenance,
  _$busRequestStatusEnum_retired,
]);

Serializer<BusRequestStatusEnum> _$busRequestStatusEnumSerializer =
    _$BusRequestStatusEnumSerializer();

class _$BusRequestStatusEnumSerializer
    implements PrimitiveSerializer<BusRequestStatusEnum> {
  ...
  @override
  final Iterable<Type> types = const <Type>[BusRequestStatusEnum];
  @override
  final String wireName = 'BusRequestStatusEnum';

  @override
  Object serialize(Serializers serializers, BusRequestStatusEnum object,
          {FullType specifiedType = FullType.unspecified}) =>
      _toWire[object.name] ?? object.name;

  @override
  BusRequestStatusEnum deserialize(Serializers serializers, Object serialized,
          {FullType specifiedType = FullType.unspecified}) =>
      BusRequestStatusEnum.valueOf(
          _fromWire[serialized] ?? (serialized is String ? serialized : ''));
}

class _$BusRequest extends BusRequest {
  @override
  ...
  @override
  final BusRequestStatusEnum? status;
  @override
  ...
  factory _$BusRequest([void Function(BusRequestBuilder)? updates]) =>
      (BusRequestBuilder()..update(updates))._build();
  ...
  _$BusRequest._(
      ...
      : super._();
  @override
  BusRequest rebuild(void Function(BusRequestBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  BusRequestBuilder toBuilder() => BusRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is BusRequest &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'BusRequest')
...
class BusRequestBuilder implements Builder<BusRequest, BusRequestBuilder> {
  _$BusRequest? _$v;
  ...
  BusRequestStatusEnum? _status;
  BusRequestStatusEnum? get status => _$this._status;
  set status(BusRequestStatusEnum? status) => _$this._status = status;
  ...
  BusRequestBuilder() {
    BusRequest._defaults(this);
  }

  BusRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(BusRequest other) {
    _$v = other as _$BusRequest;
  }

  @override
  void update(void Function(BusRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  BusRequest build() => _build();

  _$BusRequest _build() {
    final _$result = _$v ??
        _$BusRequest._(
          busNumber: BuiltValueNullFieldError.checkNotNull(
              busNumber, r'BusRequest', 'busNumber'),
          licensePlate: BuiltValueNullFieldError.checkNotNull(
              licensePlate, r'BusRequest', 'licensePlate'),
          route: route,
          capacity: capacity,
          deviceId: deviceId,
          status: status,
