...
abstract class PatchedRoute implements Built<PatchedRoute, PatchedRouteBuilder> {
  ...
  PatchedRouteLinePatternEnum? get linePattern;
...
class _$PatchedRouteSerializer implements PrimitiveSerializer<PatchedRoute> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.linePattern != null) {
      ...
      yield serializers.serialize(
        object.linePattern,
        specifiedType: const FullType(PatchedRouteLinePatternEnum),
      );
    }
      ...
      switch (key) {
        ...
        case r'line_pattern':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(PatchedRouteLinePatternEnum),
          ) as PatchedRouteLinePatternEnum;
...
class PatchedRouteLinePatternEnum extends EnumClass {

  /// Line pattern for map visualization  * `solid` - Solid Line * `dashed` - Dashed Line
  @BuiltValueEnumConst(wireName: r'solid')
  static const PatchedRouteLinePatternEnum solid = _$patchedRouteLinePatternEnum_solid;
  /// Line pattern for map visualization  * `solid` - Solid Line * `dashed` - Dashed Line
  @BuiltValueEnumConst(wireName: r'dashed')
  static const PatchedRouteLinePatternEnum dashed = _$patchedRouteLinePatternEnum_dashed;

  static Serializer<PatchedRouteLinePatternEnum> get serializer => _$patchedRouteLinePatternEnumSerializer;

  const PatchedRouteLinePatternEnum._(String name): super(name);

  static BuiltSet<PatchedRouteLinePatternEnum> get values => _$patchedRouteLinePatternEnumValues;
  static PatchedRouteLinePatternEnum valueOf(String name) => _$patchedRouteLinePatternEnumValueOf(name);
}
