...
part 'patched_bus_request.g.dart';
...
@BuiltValue()
abstract class PatchedBusRequest implements Built<PatchedBusRequest, PatchedBusRequestBuilder> {
  ...
  PatchedBusRequestStatusEnum? get status;
  ...
  factory PatchedBusRequest([void updates(PatchedBusRequestBuilder b)]) = _$PatchedBusRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PatchedBusRequestBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PatchedBusRequest> get serializer => _$PatchedBusRequestSerializer();
}

class _$PatchedBusRequestSerializer implements PrimitiveSerializer<PatchedBusRequest> {
  @override
  final Iterable<Type> types = const [PatchedBusRequest, _$PatchedBusRequest];

  @override
  final String wireName = r'PatchedBusRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    PatchedBusRequest object, {
    ...
    if (object.status != null) {
      ...
      yield serializers.serialize(
        object.status,
        specifiedType: const FullType(PatchedBusRequestStatusEnum),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required PatchedBusRequestBuilder result,
      ...
      switch (key) {
        ...
        case r'status':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(PatchedBusRequestStatusEnum),
          ) as PatchedBusRequestStatusEnum;
  ...
  @override
  PatchedBusRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PatchedBusRequestBuilder();
...
class PatchedBusRequestStatusEnum extends EnumClass {

  /// Current operational status  * `active` - Active * `maintenance` - Under Maintenance * `retired` - Retired
  @BuiltValueEnumConst(wireName: r'active')
  static const PatchedBusRequestStatusEnum active = _$patchedBusRequestStatusEnum_active;
  /// Current operational status  * `active` - Active * `maintenance` - Under Maintenance * `retired` - Retired
  @BuiltValueEnumConst(wireName: r'maintenance')
  static const PatchedBusRequestStatusEnum maintenance = _$patchedBusRequestStatusEnum_maintenance;
  /// Current operational status  * `active` - Active * `maintenance` - Under Maintenance * `retired` - Retired
  @BuiltValueEnumConst(wireName: r'retired')
  static const PatchedBusRequestStatusEnum retired = _$patchedBusRequestStatusEnum_retired;

  static Serializer<PatchedBusRequestStatusEnum> get serializer => _$patchedBusRequestStatusEnumSerializer;

  const PatchedBusRequestStatusEnum._(String name): super(name);

  static BuiltSet<PatchedBusRequestStatusEnum> get values => _$patchedBusRequestStatusEnumValues;
  static PatchedBusRequestStatusEnum valueOf(String name) => _$patchedBusRequestStatusEnumValueOf(name);
}
