...
part of 'patched_kiosk_request.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$PatchedKioskRequest extends PatchedKioskRequest {
  @override
  ...
  factory _$PatchedKioskRequest(
          [void Function(PatchedKioskRequestBuilder)? updates]) =>
      (PatchedKioskRequestBuilder()..update(updates))._build();

  _$PatchedKioskRequest._(
      ...
      : super._();
  @override
  PatchedKioskRequest rebuild(
          void Function(PatchedKioskRequestBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  PatchedKioskRequestBuilder toBuilder() =>
      PatchedKioskRequestBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is PatchedKioskRequest &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'PatchedKioskRequest')
...
class PatchedKioskRequestBuilder
    implements Builder<PatchedKioskRequest, PatchedKioskRequestBuilder> {
  _$PatchedKioskRequest? _$v;
  ...
  PatchedKioskRequestBuilder() {
    PatchedKioskRequest._defaults(this);
  }

  PatchedKioskRequestBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(PatchedKioskRequest other) {
    _$v = other as _$PatchedKioskRequest;
  }

  @override
  void update(void Function(PatchedKioskRequestBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  PatchedKioskRequest build() => _build();

  _$PatchedKioskRequest _build() {
    final _$result = _$v ??
        _$PatchedKioskRequest._(
