...
@BuiltValue()
abstract class HealthDataRequest implements Built<HealthDataRequest, HealthDataRequestBuilder> {
  ...
  factory HealthDataRequest([void updates(HealthDataRequestBuilder b)]) = _$HealthDataRequest;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(HealthDataRequestBuilder b) => b
      ..isCharging = false
      ..cameraActive = false
  ...
  static Serializer<HealthDataRequest> get serializer => _$HealthDataRequestSerializer();
}

class _$HealthDataRequestSerializer implements PrimitiveSerializer<HealthDataRequest> {
  @override
  final Iterable<Type> types = const [HealthDataRequest, _$HealthDataRequest];

  @override
  final String wireName = r'HealthDataRequest';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    HealthDataRequest object, {
  ...
  void _deserializeProperties(
    ...
    required HealthDataRequestBuilder result,
  ...
  @override
  HealthDataRequest deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = HealthDataRequestBuilder();
