...
import 'package:frontend_easy_api/src/model/api_key_create_request.dart';
import 'package:frontend_easy_api/src/model/api_key_request.dart';
...
import 'package:frontend_easy_api/src/model/boarding_event_create_request.dart';
import 'package:frontend_easy_api/src/model/boarding_event_request.dart';
import 'package:frontend_easy_api/src/model/bus.dart';
import 'package:frontend_easy_api/src/model/bus_location.dart';
import 'package:frontend_easy_api/src/model/bus_location_request.dart';
import 'package:frontend_easy_api/src/model/bus_request.dart';
...
import 'package:frontend_easy_api/src/model/device_log_request.dart';
import 'package:frontend_easy_api/src/model/face_enrollment_status.dart';
import 'package:frontend_easy_api/src/model/face_enrollment_submission_request.dart';
import 'package:frontend_easy_api/src/model/group.dart';
import 'package:frontend_easy_api/src/model/heartbeat_request.dart';
...
import 'package:frontend_easy_api/src/model/kiosk_request.dart';
...
import 'package:frontend_easy_api/src/model/parent_request.dart';
import 'package:frontend_easy_api/src/model/patched_api_key_request.dart';
import 'package:frontend_easy_api/src/model/patched_boarding_event_request.dart';
import 'package:frontend_easy_api/src/model/patched_bus_request.dart';
import 'package:frontend_easy_api/src/model/patched_kiosk_request.dart';
import 'package:frontend_easy_api/src/model/patched_parent_request.dart';
import 'package:frontend_easy_api/src/model/patched_route_request.dart';
import 'package:frontend_easy_api/src/model/patched_school_request.dart';
import 'package:frontend_easy_api/src/model/patched_student_parent_request.dart';
import 'package:frontend_easy_api/src/model/patched_student_photo_request.dart';
import 'package:frontend_easy_api/src/model/patched_student_request.dart';
import 'package:frontend_easy_api/src/model/patched_user_request.dart';
import 'package:frontend_easy_api/src/model/route.dart';
import 'package:frontend_easy_api/src/model/route_request.dart';
import 'package:frontend_easy_api/src/model/school.dart';
import 'package:frontend_easy_api/src/model/school_request.dart';
import 'package:frontend_easy_api/src/model/sos_alert.dart';
import 'package:frontend_easy_api/src/model/sos_alert_create_request.dart';
import 'package:frontend_easy_api/src/model/student.dart';
import 'package:frontend_easy_api/src/model/student_parent.dart';
import 'package:frontend_easy_api/src/model/student_parent_request.dart';
import 'package:frontend_easy_api/src/model/student_photo.dart';
import 'package:frontend_easy_api/src/model/student_photo_request.dart';
import 'package:frontend_easy_api/src/model/student_request.dart';
import 'package:frontend_easy_api/src/model/user.dart';
import 'package:frontend_easy_api/src/model/user_request.dart';
...
class ApiApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [SOSAlert] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SOSAlert>> acknowledgeSosAlert({ 
    ...
    final _path = r'/api/v1/sos/alerts/{alert_id}/acknowledge/'.replaceAll('{' r'alert_id' '}', encodeQueryParameter(_serializers, alertId, const FullType(int)).toString());
    ...
    SOSAlert? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(SOSAlert),
      ) as SOSAlert;
  ...
  Future<Response<APIKeyCreate>> apiV1ApiKeysCreate({ 
    required APIKeyCreateRequest aPIKeyCreateRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(APIKeyCreateRequest);
      _bodyData = _serializers.serialize(aPIKeyCreateRequest, specifiedType: _type);
  ...
  Future<Response<APIKey>> apiV1ApiKeysPartialUpdate({ 
    required String keyId,
    PatchedAPIKeyRequest? patchedAPIKeyRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(PatchedAPIKeyRequest);
      _bodyData = patchedAPIKeyRequest == null ? null : _serializers.serialize(patchedAPIKeyRequest, specifiedType: _type);
  ...
  Future<Response<BoardingEvent>> apiV1BoardingEventsBulkCreate({ 
    required BoardingEventRequest boardingEventRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(BoardingEventRequest);
      _bodyData = _serializers.serialize(boardingEventRequest, specifiedType: _type);
  ...
  Future<Response<BoardingEventCreate>> apiV1BoardingEventsCreate({ 
    required BoardingEventCreateRequest boardingEventCreateRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(BoardingEventCreateRequest);
      _bodyData = _serializers.serialize(boardingEventCreateRequest, specifiedType: _type);
  ...
  Future<Response<BoardingEvent>> apiV1BoardingEventsPartialUpdate({ 
    required String eventId,
    PatchedBoardingEventRequest? patchedBoardingEventRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(PatchedBoardingEventRequest);
      _bodyData = patchedBoardingEventRequest == null ? null : _serializers.serialize(patchedBoardingEventRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [BoardingEvent] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BoardingEvent>> apiV1BoardingEventsPhotosRetrieve({ 
    required String eventId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/boarding-events/{event_id}/photos/'.replaceAll('{' r'event_id' '}', encodeQueryParameter(_serializers, eventId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<Bus>> apiV1BusesAssignStudentsCreate({ 
    required BusRequest busRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(BusRequest);
      _bodyData = _serializers.serialize(busRequest, specifiedType: _type);
  ...
  Future<Response<Bus>> apiV1BusesPartialUpdate({ 
    required String busId,
    PatchedBusRequest? patchedBusRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(PatchedBusRequest);
      _bodyData = patchedBusRequest == null ? null : _serializers.serialize(patchedBusRequest, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> apiV1FaceVerificationEventsRetrieve({ 
    required String eventId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/face-verification/events/{event_id}/'.replaceAll('{' r'event_id' '}', encodeQueryParameter(_serializers, eventId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> apiV1FaceVerificationVerifyCreate({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/face-verification/verify/';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<Kiosk>> apiV1KiosksCreate({ 
    ...
    try {
      const _type = FullType(KioskRequest);
      _bodyData = kioskRequest == null ? null : _serializers.serialize(kioskRequest, specifiedType: _type);
  ...
  Future<Response<Kiosk>> apiV1KiosksPartialUpdate({ 
    required String kioskId,
    PatchedKioskRequest? patchedKioskRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(PatchedKioskRequest);
      _bodyData = patchedKioskRequest == null ? null : _serializers.serialize(patchedKioskRequest, specifiedType: _type);
  ...
  Future<Response<Parent>> apiV1ParentsCreate({ 
    required ParentRequest parentRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(ParentRequest);
      _bodyData = _serializers.serialize(parentRequest, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<ApiV1ParentsMeBusLocationsRetrieve200ResponseInner>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<ApiV1ParentsMeBusLocationsRetrieve200ResponseInner>>> apiV1ParentsMeBusLocationsRetrieve({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/parents/me/bus-locations/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<ApiV1ParentsMeBusLocationsRetrieve200ResponseInner>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(ApiV1ParentsMeBusLocationsRetrieve200ResponseInner)]),
      ) as BuiltList<ApiV1ParentsMeBusLocationsRetrieve200ResponseInner>;
    ...
    return Response<BuiltList<ApiV1ParentsMeBusLocationsRetrieve200ResponseInner>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApiV1ParentsMeBusesLocationRetrieve200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiV1ParentsMeBusesLocationRetrieve200Response>> apiV1ParentsMeBusesLocationRetrieve({ 
    required String busId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/parents/me/buses/{bus_id}/location/'.replaceAll('{' r'bus_id' '}', encodeQueryParameter(_serializers, busId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ApiV1ParentsMeBusesLocationRetrieve200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ApiV1ParentsMeBusesLocationRetrieve200Response),
      ) as ApiV1ParentsMeBusesLocationRetrieve200Response;
    ...
    return Response<ApiV1ParentsMeBusesLocationRetrieve200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApiV1ParentsMeBusesRetrieve200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiV1ParentsMeBusesRetrieve200Response>> apiV1ParentsMeBusesRetrieve({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/parents/me/buses/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ApiV1ParentsMeBusesRetrieve200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ApiV1ParentsMeBusesRetrieve200Response),
      ) as ApiV1ParentsMeBusesRetrieve200Response;
    ...
    return Response<ApiV1ParentsMeBusesRetrieve200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<Student>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<Student>>> apiV1ParentsMeChildrenList({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/parents/me/children/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<Student>? _responseData;
    ...
    return Response<BuiltList<Student>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [FaceEnrollmentStatus] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FaceEnrollmentStatus>> apiV1ParentsMeFaceEnrollmentStatusRetrieve({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/parents/me/{id}/face-enrollment/status/'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    FaceEnrollmentStatus? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(FaceEnrollmentStatus),
      ) as FaceEnrollmentStatus;
    ...
    return Response<FaceEnrollmentStatus>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Parameters:
  /// * [id] 
  /// * [faceEnrollmentSubmissionRequest] 
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [FaceEnrollmentStatus] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FaceEnrollmentStatus>> apiV1ParentsMeFaceEnrollmentSubmitCreate({ 
    required String id,
    required FaceEnrollmentSubmissionRequest faceEnrollmentSubmissionRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/parents/me/{id}/face-enrollment/submit/'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(FaceEnrollmentSubmissionRequest);
      _bodyData = _serializers.serialize(faceEnrollmentSubmissionRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [Parent] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Parent>> apiV1ParentsMeProfileRetrieve({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/parents/me/profile/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<Parent>> apiV1ParentsPartialUpdate({ 
    required String parentId,
    PatchedParentRequest? patchedParentRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(PatchedParentRequest);
      _bodyData = patchedParentRequest == null ? null : _serializers.serialize(patchedParentRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [Parent] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Parent>> apiV1ParentsRegisterCreate({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/parents/register/';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> apiV1RegenerateEmbeddingCreate({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/regenerate-embedding/';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<Route>> apiV1RoutesPartialUpdate({ 
    required String routeId,
    PatchedRouteRequest? patchedRouteRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(PatchedRouteRequest);
      _bodyData = patchedRouteRequest == null ? null : _serializers.serialize(patchedRouteRequest, specifiedType: _type);
  ...
  Future<Response<School>> apiV1SchoolsCreate({ 
    required SchoolRequest schoolRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(SchoolRequest);
      _bodyData = _serializers.serialize(schoolRequest, specifiedType: _type);
  ...
  Future<Response<School>> apiV1SchoolsPartialUpdate({ 
    required String schoolId,
    PatchedSchoolRequest? patchedSchoolRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(PatchedSchoolRequest);
      _bodyData = patchedSchoolRequest == null ? null : _serializers.serialize(patchedSchoolRequest, specifiedType: _type);
  ...
  Future<Response<StudentParent>> apiV1StudentParentsCreate({ 
    required StudentParentRequest studentParentRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(StudentParentRequest);
      _bodyData = _serializers.serialize(studentParentRequest, specifiedType: _type);
  ...
  Future<Response<StudentParent>> apiV1StudentParentsPartialUpdate({ 
    required int id,
    PatchedStudentParentRequest? patchedStudentParentRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(PatchedStudentParentRequest);
      _bodyData = patchedStudentParentRequest == null ? null : _serializers.serialize(patchedStudentParentRequest, specifiedType: _type);
  ...
  Future<Response<StudentPhoto>> apiV1StudentPhotosCreate({ 
    required StudentPhotoRequest studentPhotoRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(StudentPhotoRequest);
      _bodyData = _serializers.serialize(studentPhotoRequest, specifiedType: _type);
  ...
  Future<Response<StudentPhoto>> apiV1StudentPhotosPartialUpdate({ 
    required String photoId,
    PatchedStudentPhotoRequest? patchedStudentPhotoRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(PatchedStudentPhotoRequest);
      _bodyData = patchedStudentPhotoRequest == null ? null : _serializers.serialize(patchedStudentPhotoRequest, specifiedType: _type);
  ...
  /// * [offset] - Offset for pagination (default=0)
  /// * [search] - Search by student name, school ID, or grade
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApiV1StudentsAllRetrieve200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiV1StudentsAllRetrieve200Response>> apiV1StudentsAllRetrieve({ 
    int? limit,
    int? offset,
    String? search,
    CancelToken? cancelToken,
    ...
    final _path = r'/api/v1/students/all/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ApiV1StudentsAllRetrieve200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ApiV1StudentsAllRetrieve200Response),
      ) as ApiV1StudentsAllRetrieve200Response;
    ...
    return Response<ApiV1StudentsAllRetrieve200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<Student>> apiV1StudentsAssignBusCreate({ 
    ...
    try {
      const _type = FullType(StudentRequest);
      _bodyData = _serializers.serialize(studentRequest, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PaginatedStudentListList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PaginatedStudentListList>> apiV1StudentsList({ 
    String? ordering,
    int? page,
    String? search,
    CancelToken? cancelToken,
    ...
    PaginatedStudentListList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PaginatedStudentListList),
      ) as PaginatedStudentListList;
    ...
    return Response<PaginatedStudentListList>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<Student>> apiV1StudentsPartialUpdate({ 
    ...
    try {
      const _type = FullType(PatchedStudentRequest);
      _bodyData = patchedStudentRequest == null ? null : _serializers.serialize(patchedStudentRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [Kiosk] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Kiosk>> kioskGetMe({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/kiosks/me/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> kioskHeartbeat({ 
    required String kioskId,
    required HeartbeatRequest heartbeatRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(HeartbeatRequest);
      _bodyData = _serializers.serialize(heartbeatRequest, specifiedType: _type);
  ...
  Future<Response<KioskLog200Response>> kioskLog({ 
    required DeviceLogRequest deviceLogRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(DeviceLogRequest);
      _bodyData = _serializers.serialize(deviceLogRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [SOSAlert] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SOSAlert>> kioskTriggerSos({ 
    required String kioskId,
    SOSAlertCreateRequest? sOSAlertCreateRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/kiosks/{kiosk_id}/sos/'.replaceAll('{' r'kiosk_id' '}', encodeQueryParameter(_serializers, kioskId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(SOSAlertCreateRequest);
      _bodyData = sOSAlertCreateRequest == null ? null : _serializers.serialize(sOSAlertCreateRequest, specifiedType: _type);
  ...
  Future<Response<BusLocation>> kioskUpdateLocation({ 
    required String kioskId,
    required BusLocationRequest busLocationRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(BusLocationRequest);
      _bodyData = _serializers.serialize(busLocationRequest, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<SOSAlert>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<SOSAlert>>> listActiveSosAlerts({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/sos/alerts/active/';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<SOSAlert>? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BuiltList, [FullType(SOSAlert)]),
      ) as BuiltList<SOSAlert>;
    ...
    return Response<BuiltList<SOSAlert>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [SOSAlert] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SOSAlert>> resolveSosAlert({ 
    required int alertId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/sos/alerts/{alert_id}/resolve/'.replaceAll('{' r'alert_id' '}', encodeQueryParameter(_serializers, alertId, const FullType(int)).toString());
    final _options = Options(
      method: r'PATCH',
      headers: <String, dynamic>{
        ...?headers,
