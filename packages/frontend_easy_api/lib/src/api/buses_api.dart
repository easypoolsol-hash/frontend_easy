...
class BusesApi {
  ...
  const BusesApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [BusLocationsResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BusLocationsResponse>> busLocationsApi({ 
    ...
    BusLocationsResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BusLocationsResponse),
      ) as BusLocationsResponse;
    ...
    return Response<BusLocationsResponse>(
      data: _responseData,
  ...
  /// Returns a [Future] containing a [Response] with a [BusLocationsResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BusLocationsResponse>> busLocationsApi2({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
