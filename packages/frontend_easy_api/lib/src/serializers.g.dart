...
Serializers _$serializers = (Serializers().toBuilder()
      ...
      ..add(AuditLogActionEnum.serializer)
      ...
      ..add(PaginatedBoardingEventList.serializer)
      ..add(PaginatedBusList.serializer)
      ..add(PaginatedDeviceLogList.serializer)
      ..add(PaginatedGroupList.serializer)
      ..add(PaginatedKioskList.serializer)
      ...
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(BoardingEvent)]),
          () => ListBuilder<BoardingEvent>())
      ..addBuilderFactory(
          const FullType(
      ...
      ..addBuilderFactory(
          ...
          () => ListBuilder<Bus>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(DeviceLog)]),
          () => ListBuilder<DeviceLog>())
      ..addBuilderFactory(
