...
// tests for PatchedStudentParent
void main() {
  final PatchedStudentParent? instance = /* PatchedStudentParent(...) */ null;
  // TODO add properties to the entity

  group(PatchedStudentParent, () {
    // String student
    ...
    test('to test the property `parentDetails`', () async {
      // TODO
    });

    // String studentDetails
    test('to test the property `studentDetails`', () async {
      // TODO
    });
